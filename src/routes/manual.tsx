        ...
        <div className="min-w-0 flex-1 space-y-6">
          ...
          <div className="rounded-xl border border-slate-100 bg-white p-6 shadow-soft sm:p-8">
            ...
            <Section id="leads" title="Leads e Kanban" roles={["todos"]} lede="O coração do sistema. Cada lead é um cartão que anda por colunas conforme avança no atendimento — da primeira mensagem até a venda ou descarte.">
              ...
              <p><strong>Temperatura</strong> indica quão quente está o interesse. <strong>SLA de 5 minutos</strong> marca um lead novo como atrasado se ninguém responder a tempo. <strong>Devolver</strong> manda o lead de volta ao Bolsão sem corretor. <strong>Descartar</strong> encerra o lead — descarte extremo ("Descadastrar", "Descadastrar (Idoso)", "Descadastrar (Outra Região)", "Descadastrar (Número Errado)", "Já Comprou", "Contato Errado") exige aprovação do dono/gerente (as três variantes originais de "Descadastrar"/"Já Comprou"/"Contato Errado" também exigem observação escrita), veja <a href="#aprovacoes">Aprovações</a>. "Sem Interesse (Renda Baixa)" é um motivo comum, não exige aprovação. <strong>Fechar venda</strong> não fecha na hora — o valor e os detalhes vão pra aprovação do dono/gerente antes de virar venda de verdade.</p>
            ...
            <Section id="distribuicao" title="Distribuição de Leads" roles={["dono", "gerente"]} lede="Painel de gestão para leads que não estão sendo atendidos como deveriam. Tem seis abas.">
              ...
              <p><strong>Lead Descadastrar:</strong> só os descartes extremos (Descadastrar, Descadastrar (Idoso), Descadastrar (Outra Região), Descadastrar (Número Errado), Já Comprou em Outra Empresa, Contato Errado) que já foram aprovados pelo dono em <a href="#aprovacoes">Aprovações</a> — ficam numa aba própria porque são definitivos, diferente de um descarte normal que qualquer corretor pode reverter puxando de novo.</p>
            ...
            <Section id="followups" title="Follow-ups automáticos" roles={["todos"]} lede="Cada corretor monta uma sequência de mensagens de WhatsApp que o sistema envia sozinho pro lead — mensagem inicial + acompanhamentos.">
              ...
              <Callout title="Fluxo Geral: entra sozinho, sem precisar clicar em nada">
                ...
                <br /><br />
                <strong>Exceção:</strong> lead que você mesmo <strong>cadastra à mão</strong> não liga o fluxo Geral sozinho — se você cadastrou, é porque já está conversando com ele. Se quiser o robô mesmo assim, use o botão <strong>Iniciar follow-up</strong> na aba Follow-up do card.
              </Callout>
              ...
              <Callout title="Ritmo de envio (proteção contra bloqueio do WhatsApp)">
                Pra não parecer disparo em massa, o sistema manda no máximo <strong>1 mensagem automática a cada 3 minutos</strong> e <strong>8 por hora</strong> em cada WhatsApp de corretor, e até 40 por dia. A <strong>primeira mensagem de um lead novo sempre passa na frente</strong> e não entra no limite do dia — lead novo é chamado na hora. As mensagens de continuação de quem tem muitos leads no follow-up saem espalhadas ao longo do dia, não todas juntas às 8h.
              </Callout>
              <p><strong>Descartar quem não responde:</strong> ao criar o fluxo, no campo <em>"Se terminar todos os passos sem o cliente responder"</em>, escolha <strong>Descartar o lead</strong>. Aí, quando o último passo for enviado e o cliente nunca tiver respondido, o lead é descartado sozinho com motivo "Sem Resposta" — sai do seu Kanban e vai pra <a href="#distribuicao">Distribuição → Leads Descartados</a>. Como o motivo é "Sem Resposta", ele volta pro bolsão de rebatidas depois de 3 dias.</p>
            </Section>
